...
Stateful modules use their own name (`maf`, `emaf`, `median`, `biquad`, `slew`, `deadband`, `alphabeta`, `pid`, `ramp`, `circBuf`, `comat`, `comstxetx`, `bininp`, `hysteresis`, `complex`, `interp`, `encoder`, `hc595`, `hc597`, `dcMotor`). Check with `nm` after adding anything:
